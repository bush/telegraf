...
import (
	...
	"github.com/influxdata/telegraf/plugins/serializers/windriver"
)
...
func NewSerializer(config *Config) (Serializer, error) {
	...
	case "windriver":
		serializer, err = NewWindRiverSerializer(config.TimestampUnits)
	default:
...
func NewWindRiverSerializer(timestampUnits time.Duration) (Serializer, error) {
	return windriver.NewSerializer(timestampUnits)
}
